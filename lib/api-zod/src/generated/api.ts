...
export const AddMemberChildResponse = zod.void();
...
export const RemoveMemberChildResponse = zod.unknown();
...
export const LinkMemberToGroupResponse = zod.void();
...
export const UnlinkMemberFromGroupResponse = zod.unknown();
...
export const CreateMemberGroupResponse = zod.object({
  id: zod.string(),
  name: zod.string(),
  description: zod.string().nullish(),
  memberCount: zod.number().optional(),
...
export const DeleteMemberGroupResponse = zod.unknown();
...
export const DeleteVisitorResponse = zod.unknown();
...
export const AddVisitorVisitResponse = zod.object({
  id: zod.string(),
  visitorId: zod.string(),
  visitDate: zod.string(),
  eventId: zod.string().nullish(),
...
export const RemoveVisitorVisitResponse = zod.unknown();
...
export const CloseFinanceMonthResponse = zod.object({
  closing: zod.object({
    id: zod.string(),
    year: zod.string(),
    month: zod.string(),
...
export const AddBudgetItemsResponse = zod.object({
  items: zod
    .array(
      zod.object({
        id: zod.string(),
...
export const CreateLgpdRequestResponse = zod.object({
  id: zod.string(),
  memberId: zod.string(),
  memberName: zod.string().nullish(),
  userId: zod.string(),
...
export const CreateLessonDiscussionResponse = zod.object({
  id: zod.string(),
  lessonId: zod.string(),
  authorId: zod.string(),
  authorName: zod.string(),
...
export const AddMinistryMemberResponse = zod.object({
  id: zod.string(),
  ministryId: zod.string(),
  memberId: zod.string(),
  memberName: zod.string().nullish(),
...
export const CreateMinistryGoalResponse = zod.object({
  id: zod.string(),
  ministryId: zod.string(),
  title: zod.string(),
  description: zod.string().nullish(),
...
export const CreateServiceRoleResponse = zod.object({
  id: zod.string(),
  name: zod.string(),
  description: zod.string().nullish(),
  ministryId: zod.string().nullish(),
...
export const AddToEventScheduleResponse = zod.object({
  id: zod.string(),
  eventId: zod.string(),
  serviceRoleId: zod.string(),
  serviceRoleName: zod.string().nullish(),
...
export const CreateDirectiveResponse = zod.object({
  id: zod.string(),
  title: zod.string(),
  description: zod.string().nullish(),
  startYear: zod.string(),
...
export const AddInitiativeStepResponse = zod.object({
  id: zod.string(),
  initiativeId: zod.string(),
  title: zod.string(),
  completed: zod.boolean(),
...
export const CreateCounselingCaseResponse = zod.object({
  id: zod.string(),
  memberId: zod.string(),
  memberName: zod.string(),
  counselorId: zod.string(),
...
export const CreateCounselingSessionResponse = zod.object({
  id: zod.string(),
  caseId: zod.string(),
  date: zod.string(),
  notes: zod.string().nullish(),
...
export const CreatePastoralVisitResponse = zod.object({
  id: zod.string(),
  memberId: zod.string(),
  memberName: zod.string(),
  pastorId: zod.string(),
...
export const CreateSongSuggestionResponse = zod.object({
  id: zod.string(),
  songId: zod.string().nullish(),
  title: zod.string(),
  url: zod.string(),
...
export const CreateCultoResponse = zod.object({
  id: zod.string(),
  eventId: zod.string(),
  title: zod.string(),
  startDate: zod.string(),
...
export const AddCultoSongResponse = zod.object({
  id: zod.string(),
  cultoId: zod.string(),
  songId: zod.string(),
  songTitle: zod.string(),
...
export const CreateCouncilMeetingResponse = zod.object({
  id: zod.string(),
  meetingDate: zod.string(),
  title: zod.string(),
  agenda: zod.string().nullish(),
...
export const AddCouncilMeetingItemResponse = zod.object({
  id: zod.string(),
  meetingId: zod.string(),
  order: zod.number(),
  title: zod.string(),
...
export const CreatePixConfigResponse = zod.object({
  id: zod.string(),
  pixKey: zod.string(),
  pixKeyType: zod.string(),
  recipientName: zod.string(),
...
export const CreatePixDonationResponse = zod.object({
  id: zod.string(),
  txId: zod.string(),
  pixPayload: zod.string(),
});
